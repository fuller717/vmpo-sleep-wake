...
path = 'E:/VMPO Data/vip vmpo m3_sept2019/sleep_wake/results/averages/'  
...
stamp1 = np.loadtxt('timestamp_vip461_cno10a.txt', dtype = '|S19', delimiter = ',') 
stamp2 = np.loadtxt('timestamp_vip461_cno10a.txt', dtype = '|S19', delimiter = ',') 
